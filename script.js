const roadmapData = [
    ...
    },
    {
        ...
        sources: "Designing Data-Intensive Applications (Sách)",
    ...
    },
    {
        ...
        sources: "Practical DL (Fast.ai) + FSDL",
...
// Logic hiển thị (Kiểm tra xem là PC hay Mobile)
function showDetail(id, element) {
    ...
    // Tạo cấu trúc HTML nội dung
    const contentHTML = `
        <h2 class="content-title">${phase.title}</h2>
        <span class="content-source">📍 Souce: ${phase.sources}</span>
